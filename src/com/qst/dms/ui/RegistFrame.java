...
public class RegistFrame extends JFrame {
	...
	public RegistFrame() {
		...
		// 组合框显示的学历数组
		//String str[] = { "小学", "初中", "高中", "本科", "硕士", "博士" }; //Fuck
		Vector<String> vec = new Vector<String>();
		Boolean l = vec.add(new String("小学"));
		l = vec.add(new String("高中"));
		l = vec.add(new String("本科"));
		l = vec.add(new String("硕士"));
		l = vec.add(new String("博士"));
		cmbDegree = new JComboBox<String>(vec);
		// 设置组合框可编辑
